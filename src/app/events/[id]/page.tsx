        ...
        <div className="fade-overlay font-medium">
            <div className="text-white ml-10">
                ...
                <div className="sm:text-xl text-lg">
                    ...
                    <div className="font-oranienbaum my-2"> Chennai Institute of Technology </div>
                ...
                <div className="my-10">
                    ...
                    <div className="mt-8">
                    {curr === "description" ? <div className="font-oranienbaum sm:text-xl text-lg">{data.description}</div> :
                        curr === "rules" ? data.rules.map((item: String, index: number) => {
                            ...
                            return <div className="font-oranienbaum sm:text-xl text-lg" key={index}>{value[0].toUpperCase()} : {value[1]}</div>
                        })
                    }
                    </div>
                </div>
                ...
                { data.details.type === "ONLINE EVENT" ?
                    <Link href={data.glink || ""} className="font-oranienbaum sm:text-3xl text-xl bg-[#565656] px-8 py-3 rounded-lg">Register</Link> :
