...
const Register = () => {
  ...
  const defaultStyle = "no-underline	text-cream border border-transparent transition-all duration-200 p-[3px] rounded";
    ...
    return (
        <main className="bg-paint-effect bg-cover bg-center bg-[#272727] h-screen lg:snap-y lg:snap-mandatory overflow-x-hidden">
            <div className="w-[100vw] h-[100vh] flex justify-center items-center">
                <span className="font-passport text-white text-3xl">Click Login and Fill this for to complete Registeration</span>
            </div>
        </main>
    );
  }
        ...
        <div className="relative w-[70vw] h-[70vh] bg-[#FAFAFA] rounded-lg overflow-hidden" >
              ...
              <div className="ml-5 text-xl md:text-2xl lg:text-3xl font-passport">
                    <div className="ml-5 my-[1.5rem] sm:my-[30px] font-passport">
                        <input placeholder="name" onChange={(e)=>setName(e.target.value)} value={name} className="z-[100]"></input>
                      </div>
                      <div className="ml-5 my-[1.5rem] sm:my-[30px] font-passport"> 
                        from  <input placeholder="College" value={clg_name} onChange={(e)=>setClgName(e.target.value)}></input> to chennai institute of technology
                      </div>
                      <div className="ml-5 my-[1.5rem] sm:my-[30px]  font-passport">
                        <input placeholder="mobile" value={phone_no} onChange={(e)=>setPhoneNo(e.target.value)}></input>
                      </div>
                      ...
                      <div className="flex ml-5 flex-row font-bold  pr-5 align-center flex-wrap gap-2 md:gap-6 text-[20px] sm:text-xl md:text-2xl lg:text-3xl w-[90%] justify-center mb-[20px] items-center font-passport">
                           ...
                           <button className="rounded-lg p-2 bg-[#1E1E1E] z-[50] text-[#FFFFFF]" onClick={()=>registerUser()}>Register</button>
                      </div>
               </div>
                <Image
