  ...
  return (
    <div className="h-[100vh]">
      ...
      <section className="py-20 h-[90%]  w-full  flex flex-col items-center gap-14 md:justify-center ">
        <h1 className="text-2xl font-glb md:text-4xl text-white">
          STAY IN TOUCH WITH US !!!
        </h1>
        <section className=" z-20 flex flex-col justify-center md:flex-row max-w-[150px] text-white min-w-[150px] w-[50%] gap-14 md:gap-16 pb-20">
          <a href="https://github.com/cittakshashila">
            <svg
              className="w-[150px] h-[150px] fill-white "
              role="img"
              viewBox="0 0 24 24"
