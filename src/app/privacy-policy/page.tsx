export default function PrivacyPolicy() {
  return (
    <main className="bg-[#272727] p-8 lg:p-24 text-cream">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Takshashila, Sarathy Nagar, Kundrathur,
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Takshashila, accessible from{" "}
            <a
              href="cittakshashila.in"
      ...
      <ul>
        <li>By email: takshashila@citchennai.net</li>
      </ul>
    </main>
  );
}
